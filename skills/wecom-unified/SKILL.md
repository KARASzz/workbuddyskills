...
description_en: "The official WeCom CLI suite covers a wide range of business functions, including messaging, email, documents, tasks, schedules, meetings, WeDrive, and contact management. It supports capabilities such as proactive bot notifications, document creation and retrieval, document search, schedule creation and management, meeting booking and information retrieval, task creation and tracking, WeDrive file upload and retrieval, email sending and retrieval, and contact information access—all designed to boost enterprise office productivity."
